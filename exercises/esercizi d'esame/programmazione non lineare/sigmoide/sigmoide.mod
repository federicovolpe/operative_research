# la difficoltà del problema sta nel dover stimare l'area compresa fra le due funzioni
# (per minimizzarla).
# poichè l'integrale della sigmoide è particolarmente complesso ho scelto di approssimare il calcolo.
...
# il problema è non lineare oltre che per la funzione della sigmoide
# anche per il fatto che si richiedano di dividere variabili come nel caso di m

# il problema non è concavo poichè anche solo facendo variare la x del punto finale del primo 
# segmento si passerà da avere una soluzione non ottima a una soluzione ottima ad una ancora
# non ottimale
...
# il punto di inizio di un segmento è il punto di fine del precedente
