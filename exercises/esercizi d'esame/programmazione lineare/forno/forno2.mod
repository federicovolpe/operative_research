...
param pGarz := 12;			# prezzo all'ora del garzone

# 		VARIABILI	##########################################################
var pro {cibi}; 			# produzione di ciascun cibo [kg]
var tempoTot >= 6;			# tempo totale di lavoro [h]
...
#		OBIETTIVO	##########################################################
maximize guadagni :
	sum {c in cibi} (pro[c] * prezzi[c]) - ((tempoTot - 6) * pGarz)
;
...
la produzione rimane la medesima : non conviene fare lavorare il garzone extra