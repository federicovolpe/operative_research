# Un suo fornitore gli offre concimi di entrambi i tipi a prezzi ridotti del 50% rispetto al prezzo di listino 
#	DATI -----------------------------------------------------------
...
# il costo dei concimi viene dimezzato
param CC := 25; # costo dei concimi [€/kg]
