...
2.	Chiedendo un prestito bancario per il trimestre in questione, 
  ...
  come stabilito dal file out:
       5 prestito     NL             0             0                       -1.06 d
  non è conveniente chiedere un prestito alla banca
...
3.	Un’azienda specializzata in pubblicità di prodotti alimentari fa pervenire la seguente proposta: 
  ...
  guardare il file biscotti3.mod
  come visto nel file out:
  1 q[Svegliallegra]
                    NU           600           100           600          0.4
  Objective:  guadagni = 1032.5 (MAXimum)
  la produzione aumenterebbe portando ad un guadagno maggiore
